...
public static class WhereFilterExtensions
{
    ...
    private static bool Equal(object whereValue, JToken column, StringComparison stringComparison)
    {
    ...
    private static bool Contains(object whereValue, JToken column, StringComparison stringComparison)
    {
